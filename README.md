# Automatización de Pruebas para SVP - Sucursal Virtual Personas
### Descripción y contexto
---

Todos los días de la semana podrás realizar pagos, transferencias, consultas y conocer nuestros productos y servicios, de una manera fácil y segura. Solo necesitas un computador con conexión a Internet y lo tendrás todo a tu alcance. A toda hora y en todo momento, 
¡la Sucursal Virtual Personas está disponible para ti!

####**Estamos a tu alcance estés donde estés**
Accede a la Sucursal Virtual Personas desde donde quieras, y realiza tus pagos, transferencias y consultas financieras sin moverte de tu casa u oficina.  
Servicio ofrecido por TODO1.
...
gradlew.bat clean test --tests co.com.bancolombia.certificacion.svp.runners.transfer.TransferBetweenInvestmentFundsRunner* aggregate -i
...
Ejecutar Runner específico:
    ...
    gradlew.bat clean test --tests co.com.bancolombia.certificacion.svp.runners.funcionalidad.runnerTransaccion aggregate -i

Ejecutar paquete o funcionalidad completa:

    gradlew.bat clean test --tests co.com.bancolombia.certificacion.svp.runners.funcionalidad* aggregate -i
