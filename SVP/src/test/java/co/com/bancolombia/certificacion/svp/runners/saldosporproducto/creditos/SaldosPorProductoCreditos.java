package co.com.bancolombia.certificacion.svp.runners.saldosporproducto.creditos;
...
@CucumberOptions(
        features = "src/test/resources/features/saldosporproducto/creditos/saldos_por_producto_creditos.feature",
...
public class SaldosPorProductoCreditos {
    ...
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/saldosporproducto/creditos/saldos_por_producto_creditos.feature");
    }
}