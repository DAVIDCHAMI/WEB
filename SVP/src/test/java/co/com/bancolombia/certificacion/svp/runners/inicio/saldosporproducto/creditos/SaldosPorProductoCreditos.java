...
@CucumberOptions(
        features = "src/test/resources/features/inicio/saldosporproducto/creditos/saldosporproductocreditos.feature",
...
public class SaldosPorProductoCreditos {
    ...
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/inicio/saldosporproducto/creditos/saldosporproductocreditos.feature");
    }
}