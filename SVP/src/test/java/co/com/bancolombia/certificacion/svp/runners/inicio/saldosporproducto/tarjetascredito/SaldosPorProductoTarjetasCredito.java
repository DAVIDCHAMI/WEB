package co.com.bancolombia.certificacion.svp.runners.inicio.saldosporproducto.tarjetascredito;
...
@CucumberOptions(
        features = "src/test/resources/features/inicio/saldosporproducto/tarjetascredito/saldosporproductotarjetascredito.feature",
...
public class SaldosPorProductoTarjetasCredito {
    ...
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/inicio/saldosporproducto/tarjetascredito/saldosporproductotarjetascredito.feature");
    }
}