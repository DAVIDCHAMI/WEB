...
@CucumberOptions(
        features = "src/test/resources/features/consultasdedetalle/consulta_de_detalle_creditos.feature",
...
public class ConsultarDetalleCreditos {
    private ConsultarDetalleCreditos() {
        throw new IllegalStateException(RUNNER_CLASS);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/consultasdedetalle/consulta_de_detalle_creditos.feature");
    }
}
