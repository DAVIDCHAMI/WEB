...
public class ConsultaPagosStepDefinition {
    ...
    @Entonces("^el deberia de ver mensaje de tarjetas de credito ocultas$")
    public void elDeberiaDeVerMensajeDeTarjetasDeCreditoOcultas() {
        theActorInTheSpotlight().should(seeThat(mensajeTarjetaCreditoOculto()));
    }

    @Entonces("^el deberia de ver mensaje de credito oculto$")
    public void elDeberiaDeVerMensajeDeCreditoOculto() {
        theActorInTheSpotlight().should(seeThat(mensajeCreditosOcultos()));
    }
}