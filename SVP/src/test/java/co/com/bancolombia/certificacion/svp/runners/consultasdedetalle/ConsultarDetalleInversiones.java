...
@CucumberOptions(
        features = "src/test/resources/features/consultasdedetalle/consulta_de_detalle_de_inversion.feature",
...
public class ConsultarDetalleInversiones {
    ...
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/consultasdedetalle/consulta_de_detalle_de_inversion.feature");
    }
}