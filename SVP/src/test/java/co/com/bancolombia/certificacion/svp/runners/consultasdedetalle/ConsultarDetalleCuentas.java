...
@CucumberOptions(
        features = "src/test/resources/features/consultasdedetalle/consulta_de_detalle_ahorro_corriente.feature",
...
public class ConsultarDetalleCuentas {

    private ConsultarDetalleCuentas() {
