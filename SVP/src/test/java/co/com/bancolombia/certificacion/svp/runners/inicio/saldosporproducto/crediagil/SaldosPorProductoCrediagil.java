package co.com.bancolombia.certificacion.svp.runners.inicio.saldosporproducto.crediagil;
...
@CucumberOptions(
        features = "src/test/resources/features/inicio/saldosporproducto/crediagil/saldosporproductocrediagil.feature",
...
public class SaldosPorProductoCrediagil {
    private SaldosPorProductoCrediagil() {
        throw new IllegalStateException(RUNNER_CLASS);
    }
    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/inicio/saldosporproducto/crediagil/saldosporproductocrediagil.feature");
    }
}