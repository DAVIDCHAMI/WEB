...
Característica: Recordar usuario
  ...
  Esquema del escenario: Recordar usuario exitoso
    ...
    Ejemplos:
      ...
      |1|Acierto||||25130110|USUCTDC1|1234|1234||El usuario ha sido enviado al correo electrónico.|
  ...
  Esquema del escenario: Recordar usuario - usuario o clave invalida
    ...
    Ejemplos:
      ...
      |2|Alterno||||25130112|USUCTDC3|4321|1234||Usuario o clave inválida. Inténtalo nuevamente|
  ...
  Esquema del escenario: Bloqueo por intentos fallidos al recordar usuario
    ...
    Ejemplos:
      ...
      |3|Alterno||||25130111|USUCTDC2|1234|1234||¡Lo Sentimos!|
