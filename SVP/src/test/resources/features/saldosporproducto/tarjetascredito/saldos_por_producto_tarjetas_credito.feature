...
Característica: SVP saldos por producto
  ...
  Esquema del escenario: Consulta saldos por producto visualizar tarjetas credito
    ...
    Ejemplos:
      ...
      |1|Acierto|||||USUCTDC11|1234|1234|||****4632, ****6885, ****9658|||||Visualizar tarjetas credito|TARJETAS|
  ...
  Esquema del escenario: Consulta saldos por producto - tarjetas credito ocultas
    ...
    Ejemplos:
      ...
      |2|Acierto|||||USUCTDC2 |1234|1234|||||||Los productos están ocultos, puedes habilitarlos nuevamente en la opción "Productos/ Administrar productos propios".|Tarjetas credito ocultas|TARJETAS|
  ...
  Esquema del escenario: Consulta saldos por producto sin tarjetas de credito
    ...
    Ejemplos:
      ...
      |3|Acierto|||||PRUEBAENROL5 |1234|1234||406-762410-20||||||Sin tarjetas de credito|TARJETAS|