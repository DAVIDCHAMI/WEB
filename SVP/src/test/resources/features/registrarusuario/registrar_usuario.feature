...
Característica: Registro de usuarios
  ...
  Esquema del escenario: Registro de usuario exitoso
    ...
    Entonces el deberia de ver el mensaje de ¡Registro exitoso!
    Ejemplos:
      | idCaso | orientacion | codigoTransaccion | codigoError | resultadoEsperado | numeroDocumento | usuario   | clave | segundaClave | tipoDocumento |
  ...
  Esquema del escenario: Registro de usuario fallido
    ...
    Entonces el deberia de ver el mensaje de Registro de usuario incorrecto
    Ejemplos:
      | idCaso | orientacion | codigoTransaccion | codigoError | resultadoEsperado | numeroDocumento | usuario   | clave | segundaClave | tipoDocumento |
  ...
  Esquema del escenario: Registro de usuario con usuario ya existente
    ...
    Entonces el deberia de ver el mensaje Ingresa otro usuario. El que ingresaste ya esta en uso
    Ejemplos:
      | idCaso | orientacion | codigoTransaccion | codigoError | resultadoEsperado | numeroDocumento | usuario   | clave | segundaClave | tipoDocumento |
