...
public class DetalleFondosInversion {
    ...
    public static final Target LBL_TIPO_FONDO = Target.the("Label para validar el tipo de fondo").located(By.xpath("//div[contains(@id,'AccountType')]/span/..//div/span[contains(text(),'')]"));
    ...
    public static final Target LBL_FECHA_VENCIMIENTO_FONDO = Target.the("Label para validar la fecha de vencimiento del fondo").located(By.xpath("//div[contains(@id,'ExpirationDate')]/span/..//div/span[contains(text(),'')]"));
