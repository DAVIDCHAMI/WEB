...
public class RecordarUsuarioPage {
    public static final Target TXT_NUMERO_DOCUMENTO = Target.the("Campo numero de documento").locatedBy("//input[@id='InputUserDocument']");
    public static final Target TXT_CLAVE = Target.the("Campo clave de usuario").locatedBy("//input[@id='InputUserPassword']");
    public static final Target BTN_RECORDAR = Target.the("Boton Recordar").locatedBy("//button[@id='RememberButton']");
