...
public class GenerarClavePage {
    ...
    public static final Target LBL_CONFIRMACION_GENERAR = Target.the("Label Confirmar Generar clave").locatedBy("//div[@id='b3-Tittle']/div/following-sibling::div[contains(.,'{0}')]");
