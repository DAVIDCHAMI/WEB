...
import static co.com.bancolombia.certificacion.svp.userinterface.consultasdedetalle.DetalleCreditos.LBL_DETALLE_CREDITOS;
...
public class ConsultasCredito implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        if ("Creditos".equals(obtener(PRODUCTO))) {
        ...
        actor.attemptsTo(Click.on(LBL_PRODUCTOS.of(obtener(NUMERO_PRODUCTO))),
                WaitUntil.the(LBL_DETALLE_CREDITOS, isVisible()),
                Esperar.unTiempo()
        );
    }
