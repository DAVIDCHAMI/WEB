...
import static co.com.bancolombia.certificacion.svp.userinterface.consultasdedetalle.DetalleFondosInversion.LBL_DETALLE_FONDO;
...
public class ConsultasFondosInversion implements Task {

    public static ConsultasFondosInversion consultarDetalleFondosInversion() {
        return instrumented(ConsultasFondosInversion.class);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Click.on(LBL_PRODUCTOS.of(obtener(NUMERO_PRODUCTO))),
                WaitUntil.the(LBL_DETALLE_FONDO, isVisible()),
                Esperar.unTiempo()
        );
    }
}